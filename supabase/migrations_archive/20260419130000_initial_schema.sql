...
drop policy if exists "practice_entries_manage_scoped_members" on public.practice_entries;
create policy "practice_entries_manage_scoped_members"
on public.practice_entries
for all
to authenticated
...
drop policy if exists "season_goals_manage_scoped_members" on public.season_goals;
create policy "season_goals_manage_scoped_members"
on public.season_goals
for all
to authenticated
using (public.can_manage_player(player_id))
